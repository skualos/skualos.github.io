...
I chose to create the blog using [Jekyll](http://jekyllrb.com/){:target="_blank"} and host it on [Github](https://github.com/){:target="_blank"}. It seems to be a good workflow for a simple blog, and it will also be a way for me to learn hoe to manage project using Git.
